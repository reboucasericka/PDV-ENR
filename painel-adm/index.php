	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container-fluid">
			<a class="navbar-brand" href="index.php">
				<img src="../img/logo-text-branco.png" width="50">
			</a>
...
<!--- FORM PERFIL -->
			<form method="POST" id="form-perfil">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="nif-perfil" name="nif-perfil" placeholder="nif" required="" value="<?php echo @$nif_usu ?>">
							</div>
						</div>
					</div>
					<div class="mb-3">
					...
					<small>
						<div align="center" class="mt-1" id="mensagem-perfil"></div>
					</small>
				</div>
				...
				<div class="modal-footer">
					...
					<input name="antigo-perfil" type="hidden" value="<?php echo @$nif_usu ?>">
