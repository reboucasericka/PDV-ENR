				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="NIF" name="NIF" placeholder="NIF" required="" value="<?php echo @$NIF ?>">
							</div>  
						</div>
					</div>		
					...
					<div class="mb-3">
						...
						<select class="form-select mt-1" aria-label="Default select example" name="nivel">
							...
							<option <?php if(@$nivel == 'Administrativo'){ ?> selected <?php } ?>  value="Administrativo">Administrador</option>

							<option <?php if(@$nivel == 'Gerente'){ ?> selected <?php } ?>  value="Gerente">Gerente</option>
