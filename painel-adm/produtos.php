					...
					if($total_reg_2 > 0){ 
						...
						<tr>
							...
							<td>
								...
								<a href="#" onclick="mostrarDados('<?php echo $res[$i]['nome'] ?>', '<?php echo $res[$i]['descricao'] ?>', '<?php echo $res[$i]['foto'] ?>',
								 '<?php echo $categoria ?>', '<?php echo $fornecedor ?>',  title="Ver Descriçao" style="text-decoration: none">
...
<!--MODAL PARA MOSTRAR DADOS DO PRODUTO -->
...
<!--AJAX PARA MOSTRAR DADOS DO PRODUTO -->
<script type="text/javascript">
