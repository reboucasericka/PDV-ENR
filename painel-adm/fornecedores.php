				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td><?php echo $res[$i]['nif'] ?></td>
							<td><?php echo $res[$i]['email'] ?></td>

							<td><?php echo $res[$i]['telemovel'] ?? '' ?></td>
							<td>
...
if (@$_GET['funcao'] == "editar") {
	...
	$id_editar = $_GET['id'];
	$query = $pdo->prepare("SELECT * from fornecedores where id = :id");
						...
						<div class="col-md-6">
								<div class="mb-3">
									...
									<select class="form-select mt-1" aria-label="Default select example" name="tipo">
										...
										<option <?php if (@$tipo_pessoa == 'Empresa') { ?> selected <?php } ?> value="Empresa">Empresa</option>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="telemovel" name="telemovel" placeholder="Telemovel" required="" value="<?php echo @$telemovel ?>">
							</div>
						</div>						
...
<!-- Mensagem de Erro/Sucesso -->
				...
				<div class="modal-footer">
					...
					<input name="antigo" type="hidden" value="<?php echo @$nif ?>">
...
<!--MODAL PARA MOSTRAR OS DADOS DO FORNECEDOR NO MODAL DE DADOS-->
...
<!--FIM MODAL PARA MOSTRAR OS DADOS DO FORNECEDOR NO MODAL DE DADOS-->
...
<!--SCRIPT PARA MOSTRAR OS DADOS DO FORNECEDOR NO MODAL DE DADOS-->
<script type="text/javascript">
